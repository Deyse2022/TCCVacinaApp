        ...
        try {
            ...
            if (cursor.moveToFirst()) {
                do {
                    ...
                    usuario.setTipoperfil(cursor.getString(cursor.getColumnIndex(UsuarioDataModel.TIPOPERFIL)));
                    usuario.setCnes(cursor.getString(cursor.getColumnIndex(UsuarioDataModel.CNES)));
